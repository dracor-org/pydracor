...
class PlayWithWikidataCharacter(BaseModel):
    """
    PlayWithWikidataCharacter
    """ # noqa: E501
    character_name: Optional[StrictStr] = Field(default=None, alias="characterName")
    title: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    uri: Optional[StrictStr] = None
    authors: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["characterName", "title", "id", "uri", "authors"]
